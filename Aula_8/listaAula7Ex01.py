...
do tipo lista chamada Estoque. Pense no seguinte cenário, acaba de chegar um 
novo estoque de um novo produto 'boné' adicione esse novo produto à lista e 
remova o produto 'calça' que não tem estoque disponível.
'''
